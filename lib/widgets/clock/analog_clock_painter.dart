...
class AnalogClockPainter extends CustomPainter {
  ...
  AnalogClockPainter(
      ...
      this.handStrokeWidth = STROKE_WIDTH,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (innerBackgroundColor != null) {
      _paintBackground(canvas, size, scaleFactor);
    }
  ...
  _paintPinHole(canvas, size, scaleFactor) {
    Paint midPointStrokePainter = Paint()
      ...
      ..strokeWidth = handStrokeWidth * scaleFactor
      ..isAntiAlias = true
  ...
  _paintBackground(canvas, size, scaleFactor) {
    Path oval = Path()
      ..addOval(Rect.fromCircle(
          center: size.center(Offset.zero), radius: BASE_SIZE / 2));
    ...
    canvas.drawCircle(
        size.center(Offset.zero), BASE_SIZE / 2 - 15, midPointStrokePainter);
  }
